...
const OutletOrderReport: React.FC = () => {
  ...
  const handleDeleteHistory = async () => {
    setIsDeleting(true);
    try {
      // Menghapus semua stock movements tipe distribusi
      // Ini akan menghapus record transaksi dan mengembalikan stok secara logis
      ...
      toast.success("Semua riwayat pesanan outlet berhasil dihapus.");
          ...
          <div className="bg-red-50 border border-red-100 rounded-lg p-4 flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-red-700 mt-1">
                Tindakan ini akan menghapus <strong>SEMUA</strong> riwayat transaksi distribusi outlet dari sistem.
